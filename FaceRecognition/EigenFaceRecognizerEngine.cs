...
namespace Emgu.CV
{
    ...
    /// </summary>
    [Serializable]
    public class EigenFaceRecognizerEngine
    {
       ...
       /// <summary>
        ...
        public EigenFaceRecognizerEngine()
        {
        ...
        public EigenFaceRecognizerEngine(Image<Gray, Byte>[] images, ref MCvTermCriteria termCrit)
        ...
        /// <param name="termCrit">The criteria for recognizer training</param>
        public EigenFaceRecognizerEngine(Image<Gray, Byte>[] images, String[] labels, ref MCvTermCriteria termCrit)
        ...
        /// </param>
        /// <param name="termCrit">The criteria for recognizer training</param>
        public EigenFaceRecognizerEngine(Image<Gray, Byte>[] images, String[] labels, double eigenDistanceThreshold, ref MCvTermCriteria termCrit)
        {
        ...
        public String Recognize(Image<Gray, Byte> image)
        {
            ...
            _eigenDistanceThreshold = TresholdValue.SetTresholdVal;
